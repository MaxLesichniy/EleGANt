...
# python3 scripts/main.py transfer --input assets/images/non-makeup/source_1.png --output result/resut.png --ref assets/images/makeup/reference_1.png
...
def inference(input, output, reference, load_path, mask_area):
...
def parse_args(args = None):
    ...
    parser.add_argument("--load_path", type=str, help="folder to load model", default='ckpts/sow_pyramid_a5_e3d2_remapped.pth')
